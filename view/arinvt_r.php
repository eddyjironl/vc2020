<html>
	<head>
		...
		<link rel="stylesheet" href="../css/arinvt_r.css"> 
 		<script src="../js/vc_funciones.js"></script> 
 		<script src="../js/arinvt_r.js"></script> 
	</head>
	<body>
		<form target="_blank" method="POST" action="../reports/rpt_arinvt.php" id="arinvt_r" name="arinvt_r" class= "form2">
