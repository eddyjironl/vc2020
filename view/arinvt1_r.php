<html>
	<head>
		<title>Resumen de Utilidades y Costos</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<link rel="stylesheet" href="../css/vc_estilos.css"> 
		<link rel="stylesheet" href="../css/arinvt1_r.css"> 
 		<script src="../js/vc_funciones.js"></script> 
 		<script src="../js/arinvt1_r.js"></script> 
	</head>
	<body>
		<form target="_blank" method="POST" action="../reports/rpt_arinvt1.php" id="arinvt1_r" name="arinvt1_r" class= "form2">
			<script> get_barraprint("Resumen Utilidades y Costos","Resumen de Utilidades y costos");</script>
			<fieldset class="fieldset" id="area_visualizaciones">
				...
				<select id="corden" name="corden" class="listas">
					...
					<option value = "cinvno">Por Factura</option>
					<option value = "cpaycode">Por Condiciones</option>
					<option value = "cwhseno">Por Bodega</option>
					<option value = "dstar">Por Fecha Factura</option>
				</select>
			</fieldset>
			<br>
			<fieldset id="area_filtros" class="fieldset">
					...
					<br>
						...
						<label class = "labelfiltro">Aticulo Id</label>
