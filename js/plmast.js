function init(){
	...
	document.getElementById("btnueva").addEventListener("click",get_clear_view_plmast,false);
    ...
    document.getElementById("btcdptno").addEventListener("click",function(){
    ...
    document.getElementById("quit2").addEventListener("click",cerrar_pantalla,false);
    // ----------------------------------------------------------------------------------------------
}
function reset_msg(){
